INSERT INTO public.departaments (id, name, functions, description) VALUES
-- Administrativos
('db1d4100-6d26-4410-8ce6-c81d407823ea', 'Administração Central', 'ADMINISTRATIVE', 'Gestão geral da fazenda'),
('7ae895e0-6b47-4e44-86e9-351c17de6f24', 'RH', 'ADMINISTRATIVE', 'Recursos Humanos e folha de pagamento'),

-- Financeiros
('d5dd4862-5641-4324-9624-1b9db8cfcaea', 'Financeiro', 'FINANCIAL', 'Gestão financeira e contábil'),
('3f260f1f-496f-4ab7-b538-10b231a1f89d', 'Tesouraria', 'FINANCIAL', 'Fluxo de caixa e bancos'),

-- Operacionais
('e537160e-02de-4dda-a483-8bbe307dc8ae', 'Agricultura', 'AGRICULTURAL', 'Plantio, colheita e cultivos'),
('04c6907d-d72c-407a-9425-b5ec062b9662', 'Pecuária', 'LIVESTOCK', 'Criação e manejo animal'),
('54383fab-4443-4d55-af40-3c67080d7578', 'Irrigação', 'OPERATIONAL', 'Manejo hídrico e sistemas de irrigação'),

-- Técnicos
('8fa31203-86ad-443c-8a13-0f7fe3b4e3ce', 'Manutenção', 'MAINTENANCE', 'Equipamentos e infraestrutura'),
('03462a02-3ead-4b3b-b262-b55b05898759', 'Técnico Agrícola', 'TECHNICAL', 'Assistência técnica e planejamento'),
('3102644e-36b9-40f5-a234-4f1b0551b7b6', 'Veterinário', 'TECHNICAL', 'Saúde animal e controle sanitário'),

-- Comercial
('6124f247-0640-42d3-b67b-cc2a7cccce43', 'Vendas', 'COMMERCIAL', 'Comercialização da produção'),
('78f68344-39cd-4c6d-a55d-295c287767bf', 'Marketing', 'COMMERCIAL', 'Divulgação e relações comerciais');
